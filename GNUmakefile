...
.PHONY: host-launcher-test host-device-test release-iso
...
$(KERNEL): $(DEVICE_OBJ) $(STORAGE_OBJ) $(CONFIG_STORE_OBJ) $(IRQ_FRAME_OBJ) $(USER_CONTEXT_OBJ) $(USER_SCHED_OBJ) $(USER_RESUME_OBJ) $(USER_LAUNCH_OBJ)
...
check: host-launcher-test host-device-test