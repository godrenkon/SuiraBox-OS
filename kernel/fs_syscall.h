...
uint64_t sb_fs_read(int32_t fd, void *buffer, uint32_t length);
uint64_t sb_fs_write(int32_t fd, const void *buffer, uint32_t length);
uint64_t sb_fs_close(int32_t fd);
