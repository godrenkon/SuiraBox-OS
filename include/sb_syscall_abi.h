#ifndef SB_SYSCALL_ABI_H
#define SB_SYSCALL_ABI_H

#include <stdint.h>
#include "sb_fs_abi.h"

#define SB_SYSCALL_ABI_MAJOR   1u
#define SB_SYSCALL_ABI_MINOR   4u
...
#define SB_SYS_APP_TERMINATE      29u
#define SB_SYS_APP_STATUS         30u

#define SB_CONFIG_SET_VOLATILE    1u

_Static_assert(SB_SYSCALL_ABI_MAJOR == 1u, "syscall ABI major changed");
_Static_assert(SB_SYSCALL_ABI_MINOR == 4u, "syscall ABI minor changed");
...
_Static_assert(SB_SYS_APP_TERMINATE == 29u, "app terminate syscall number changed");
_Static_assert(SB_SYS_APP_STATUS == 30u, "app status syscall number changed");
